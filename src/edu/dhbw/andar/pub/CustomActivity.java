...
public class CustomActivity extends AndARActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			("red", "patt.hiro", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);
			
			someObject = new CustomObject
			("green", "android.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);

			someObject = new CustomObject
			("blue", "barcode.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);
...
/**
			...
			someObject = new CustomObject
			("red", "red.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);
			
			someObject = new CustomObject
			("blue", "blue.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);
			
			someObject = new CustomObject
			("green", "green.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);
			
			someObject = new CustomObject
			("facebook", "facebook.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);
